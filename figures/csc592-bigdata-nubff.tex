\begin{figure}[H]
    ...
    $\mathcolorbox{lightpurple}{111}$, respectively. 
    Each key hashes to three or four consecutive segments. Corresponding entries are marked by arrows and matching colors. Dashed gray arrows indicate hashes to
    the phantom entry. For example, since the filter contains $\mathcolorbox{lightred}{y}$, the bitwise-XOR 
    $\protect\gradientmathbox{lightorange}{lightred}{101} \oplus \protect\gradientmathbox{lightorange}{lightred}{000} \oplus \protect\gradientmathbox{lightred}{lightpink}{110} \oplus \mathcolorbox{lightgray}{000}$
    is the fingerprint $\mathcolorbox{lightred}{011}$. See Figure~\ref{fig:csc592_bigdata_nusoe} and Figure~\ref{fig:csc592_bigdata_nuhg} for the induced 
    system of equations and hypergraph.}
