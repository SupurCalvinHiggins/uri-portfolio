...
\end{array}
\]
\caption{System of linear equations with variables in $\mathbb{F}^3_2$ induced by Figure~\ref{fig:csc592_bigdata_bff}. Each $A[i]$ is the $i$-th entry in the 
...
$\mathcolorbox{lightpurple}{111}$, respectively. Array entries and fingerprints are marked with corresponding key color(s). There is one equation for each key.}
