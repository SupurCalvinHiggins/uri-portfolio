\begin{figure}[H]
    ...
    Each key hashes to three consecutive segments. Corresponding entries are marked by arrows and matching colors. For example, since the filter contains 
    $\mathcolorbox{lightorange}{x}$, the bitwise-XOR 
    $\mathcolorbox{lightorange}{110} \oplus \mathcolorbox{lightorange}{000} \oplus \protect\gradientmathbox{lightorange}{lightred}{010}$ is the fingerprint 
    $\mathcolorbox{lightorange}{100}$.}
